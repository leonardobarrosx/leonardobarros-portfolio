 ...
 * on paper (some hues need a darker tone there to stay readable).
 */
...
function make(id: ThemeId, c: {
  ...
  d900: string; d800: string; d700: string; soft: string; mute: string;
}): Theme {
  return {
    id,
    tokens: {
...
export const THEMES: Theme[] = [
  // the current look: cool paper, violet ink, plum darks
  ...
  // the original: warm cream, red ink, coffee darks
  ...
  // monochrome: black ink on off-white, greys doing the work colour does elsewhere
  make("ink", { accent: "#2e2e2e", deep: "#000000", light: "#d6d6d6", text: "#111111", split: "#8a8a8a", paper: "#f1f0ee", paper2: "#e3e1dd", ink: "#111111", ink2: "#2a2a2a", d900: "#161616", d800: "#4a4a4a", d700: "#333333", soft: "#bdbdbd", mute: "#666666" }),
];
